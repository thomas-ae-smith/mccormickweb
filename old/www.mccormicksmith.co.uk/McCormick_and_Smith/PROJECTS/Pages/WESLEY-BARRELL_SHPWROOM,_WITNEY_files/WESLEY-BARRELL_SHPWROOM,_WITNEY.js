...
{return IWCreatePhotocast("http://www.mccormicksmith.co.uk/McCormick_and_Smith/PROJECTS/Pages/WESLEY-BARRELL_SHPWROOM,_WITNEY_files/rss.xml",true);}
...
IWLayoutPhotoGrid('id1',new IWPhotoGridLayout(3,new IWSize(189,189),new IWSize(189,0),new IWSize(189,204),27,27,0,new IWSize(2,2)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,null,'../../Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('WESLEY-BARRELL_SHPWROOM,_WITNEY_files/WESLEY-BARRELL_SHPWROOM,_WITNEYMoz.css')
