...
{return IWCreatePhotocast("http://www.mccormicksmith.co.uk/McCormick_and_Smith/PROJECTS/Pages/CHANTRY_files/rss.xml",false);}
...
IWLayoutPhotoGrid('id1',new IWPhotoGridLayout(3,new IWSize(191,191),new IWSize(191,0),new IWSize(191,206),27,27,0,new IWSize(2,2)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,null,'../../Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('CHANTRY_files/CHANTRYMoz.css')
