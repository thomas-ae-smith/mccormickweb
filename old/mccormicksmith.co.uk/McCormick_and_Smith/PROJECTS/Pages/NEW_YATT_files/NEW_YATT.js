...
{return IWCreatePhotocast("http://www.mccormicksmith.co.uk/McCormick_and_Smith/PROJECTS/Pages/NEW_YATT_files/rss.xml",true);}
...
IWLayoutPhotoGrid('id1',new IWPhotoGridLayout(3,new IWSize(208,208),new IWSize(208,0),new IWSize(208,223),27,27,0,new IWSize(2,2)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,null,'../../Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('NEW_YATT_files/NEW_YATTMoz.css')
